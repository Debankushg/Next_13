      ...
      <section className='w-3/4 mx-auto flex flex-col gap-10'>
        ...
        <form className='flex flex-col gap-5'>
          <div className={styles.input_group}>
            <input type='text' name='userName' placeholder='UserName' className={styles.input_textBox} />
          ...
          <div className={styles.input_group}>
            <input type={`${show.password ? "text" : "password"}`} name='password' placeholder='password' className={styles.input_textBox} />
          ...
          <div className={styles.input_group}>
            <input type={`${show.cpassword ? "text" : "password"}`} name='cPassword' placeholder='Confirm Password' className={styles.input_textBox} />

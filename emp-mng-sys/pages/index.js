    ...
    <>
      ...
      <div className=' bg-slate-300'>
        <div className='bg-gray-900 relative  py-4 px-4'>
          ...
          {!session?.user ? (<div className='flex justify-end absolute'>
          ...
          </div>) : (<div className="flex justify-end absolute ">
            <button className="bg-red-500 hover:bg-red-600  hover:text-white text-white font-bold py-4 px-14 right-[200px] top-[10px] rounded-md mb-2 ml-2 fixed " onClick={() => signOut()}>Sign Out</button>
          </div>)}
        </div>
